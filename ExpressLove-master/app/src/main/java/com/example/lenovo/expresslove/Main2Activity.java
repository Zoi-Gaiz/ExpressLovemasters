...
//2.设置属性
                ...
                b.setPositiveButton("没有", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {
                        AlertDialog.Builder c = new AlertDialog.Builder(Main2Activity.this);
                        c.setTitle("憨憨包子：");
                        c.setMessage("单身是一种优雅");
                        c.setPositiveButton("没毛病", new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialogInterface, int i) {
                                AlertDialog.Builder d = new AlertDialog.Builder(Main2Activity.this);
                                d.setTitle("憨憨包子：");
                                d.setMessage("单身是一种幸福");
                                d.setNegativeButton("没毛病", new DialogInterface.OnClickListener() {
                                    @Override
                                    public void onClick(DialogInterface dialogInterface, int i) {
                                        AlertDialog.Builder y = new AlertDialog.Builder(Main2Activity.this);
                                        y.setTitle("憨憨包子记住：");
                                        y.setMessage("男人的嘴骗人的鬼！！！");
    ...
    public boolean onKeyUp(int keyCode, KeyEvent event) {
        if(keyCode == KeyEvent.KEYCODE_BACK){
            new CommomDialog(this, R.style.dialog, "？我辛辛苦苦给你做的礼物还想走？", new CommomDialog.OnCloseListener() {
                @Override
